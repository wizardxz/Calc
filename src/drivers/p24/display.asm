...
@;Parameter r1 is the value of number we want to write.
	...
	.macro def_write_digit func_name dot
	def \func_name
		push {r3-r7,lr}
		push {r1}
	...
	1:	cmp r0, #1;		bne 1f;	set_lat 0,0,0,1,0,0,0,0;	b 2f	@;cursor
	1:	cmp r0, #48;	bne 1f;	set_lat 1,1,1,1,1,1,0,\dot;	b 2f	@;write '0'
	1:	cmp r0, #49;	bne 1f;	set_lat 0,1,1,0,0,0,0,\dot;	b 2f	@;write '1'
	1:	cmp r0, #50;	bne 1f;	set_lat 1,1,0,1,1,0,1,\dot;	b 2f	@;write '2'
	1:	cmp r0, #51;	bne 1f;	set_lat 1,1,1,1,0,0,1,\dot;	b 2f	@;write '3'
	1:	cmp r0, #52;	bne 1f;	set_lat 0,1,1,0,0,1,1,\dot;	b 2f	@;write '4'
	1:	cmp r0, #53;	bne 1f;	set_lat 1,0,1,1,0,1,1,\dot;	b 2f	@;write '5'
	1:	cmp r0, #54;	bne 1f;	set_lat 1,0,1,1,1,1,1,\dot;	b 2f	@;write '6'
	1:	cmp r0, #55;	bne 1f;	set_lat 1,1,1,0,0,0,0,\dot;	b 2f	@;write '7'
	1:	cmp r0, #56;	bne 1f;	set_lat 1,1,1,1,1,1,1,\dot;	b 2f	@;write '8'
	1:	cmp r0, #57;	bne 1f;	set_lat 1,1,1,1,0,1,1,\dot;	b 2f	@;write '9'
	...
	def_write_digit write_digit 0
	def_write_digit write_digit_with_dot 1
